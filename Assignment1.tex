...
\\X=1 iff first ball is black and X=0 iff first ball is white.
...
\begin{align}
P(Y=0|X=0)=\frac{P(X=0\cap Y=0)}{P(X=0)}
\end{align}

from equations (2.0.1),(2.0.2) and (2.0.3)
\begin{align}
P(X=0\cap Y=0)=P(X=0)\times P(Y=0|X=0)
\\\implies P(X=0 \cap Y=0)=\frac{3}{7}=0.428571428571..
\end{align}
